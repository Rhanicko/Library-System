...
public class Admin {
	...
	public void admin() {
        ...
        addBookButton.addActionListener(e -> {
            ...
            int result = JOptionPane.showConfirmDialog(frame, panel, "Enter Book Details", JOptionPane.OK_CANCEL_OPTION);
        ...
        removeBookButton.addActionListener(e -> {
            ...
            int result = JOptionPane.showConfirmDialog(frame, panel, "Select Book to Remove", JOptionPane.OK_CANCEL_OPTION);
            if (result == JOptionPane.OK_OPTION) {
